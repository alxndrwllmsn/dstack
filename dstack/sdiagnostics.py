...
#= Get optical image
def get_optical_image(catalog_path, source_index, survey='DSS2 Red', N_pixel=600):
...
def get_optical_image_ndarray(source_ID, sofia_dir_path, name_base, N_optical_pixels=600):
    ...
    return optical_im, optical_im_wcs
...
def plot_optical_background_with_mom0_conturs(source_ID, sofia_dir_path, name_base, output_fname, contour_levels=[3,5,7,9,11], N_optical_pixels=600, b_maj=30, b_min=30, b_pa=0, **kwargs):
    ...
    optical_im, optical_im_wcs = get_optical_image_ndarray(source_ID, sofia_dir_path, name_base, N_optical_pixels=N_optical_pixels)
...
if __name__ == "__main__":
    ...
    plot_optical_background_with_mom0_conturs(source_ID = 1,
            sofia_dir_path = '/home/krozgonyi/Desktop/quick_and_dirty_sofia_outputs/stacked_grids/',
            name_base = 'beam17_all_',
            output_fname = '/home/krozgonyi/Desktop/test.png',
            N_optical_pixels=1000)

    exit()

    plot_mom1_map(source_ID = 1,
            sofia_dir_path = '/home/krozgonyi/Desktop/quick_and_dirty_sofia_outputs/stacked_grids/',
            name_base = 'beam17_all_',
            output_fname = '/home/krozgonyi/Desktop/test.png')
